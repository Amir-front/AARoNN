...
const Projects = () => {
  return (
    <section className="flex flex-col justify-center items-center p-5 mt-24 md:mt-28">
      <h1 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center">
        My Projects Highlight
      </h1>
      {/* <Link to="/project">
        <button className="rounded-4xl border-2 border-orange-400 text-white flex flex-row justify-center items-center p-5 cursor-pointer hover:bg-orange-400 active:bg-amber-400 transition-all hover:py-6 active:py-6 my-10 text-lg md:text-xl lg:text-2xl">
          Explore More <img src={Arrow} alt="Arrow" className="ml-5" />
        </button>
      </Link> */}
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-32">
        <div className="flex flex-col text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-white">
